...
\input{custom-fontset.def}

% \setCJKfamilyfont{zhsong}[AutoFakeBold=true]{SimSun} % 启用伪粗体
...
{   
    ...
    \author{
        \vspace{0.5cm}
        \kaishu\Large 学院\ \dlmu[9cm]{集成电路科学与工程学院} \\ %学院
        \vspace{0.5cm}
        \kaishu\Large 专业\ \dlmu[9cm]{集成电路工程} \\ %班级
        \vspace{0.5cm}
        \kaishu\Large 学号\ \dlmu[9cm]{ZY2441127} \qquad  \\ %学号
        \vspace{0.5cm}
        \kaishu\Large 姓名\ \dlmu[9cm]{刘雪慧} \qquad \\ %姓名 
    }
